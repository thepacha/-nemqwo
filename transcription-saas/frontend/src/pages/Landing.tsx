      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-600 mb-8 max-w-3xl mx-auto">
            ...
            Fast, reliable, and secure transcription for professionals.
          </p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            Powerful features designed for modern transcription needs
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <p className="text-gray-600">
              Get your transcriptions in minutes, not hours. Our AI processes audio files at incredible speeds.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <p className="text-gray-600">
              State-of-the-art AI ensures the highest accuracy rates in the industry.
            </p>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-lg">
            ...
            <p className="text-gray-600">
              Your audio files are encrypted and processed securely. We never store your content.
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="border-2 border-gray-200 rounded-xl p-8">
              ...
              <Link
                to="/register"
                className="w-full bg-gray-200 hover:bg-gray-300 text-gray-800 py-3 px-6 rounded-lg font-semibold text-center block transition-colors"
              >
                Get Started
              </Link>
            </div>
