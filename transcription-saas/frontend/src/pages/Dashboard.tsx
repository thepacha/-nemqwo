...
const Dashboard: React.FC = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const transcriptions = await transcriptionService.getTranscriptions(0, 5);
        setRecentTranscriptions(transcriptions);
        
        // Calculate stats
        const totalTranscriptions = transcriptions.length;
        const totalMinutes = transcriptions.reduce((acc, t) => acc + (t.duration || 0), 0);
        ...
        setStats({ totalTranscriptions, totalMinutes, thisMonth });
      } catch (error) {
        ...
        <div className="bg-white p-6 rounded-lg shadow">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <p className="text-2xl font-bold text-gray-900">{Math.round(stats.totalMinutes / 60)}</p>
            </div>
          </div>
        </div>
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            >
              ...
              <div>
                <p className="font-medium text-gray-900">New Transcription</p>
                <p className="text-sm text-gray-600">Upload audio file</p>
              </div>
            </Link>
            ...
            >
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">All transcriptions</p>
              </div>
            </Link>
        ...
        <div className="p-6">
          ...
          {recentTranscriptions.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 mb-4">No transcriptions yet</p>
              <Link
                to="/transcribe"
